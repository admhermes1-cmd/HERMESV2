...
public class AppException extends RuntimeException {
    ...
    /**
     * Cria uma exceção indicando que o campo célula é obrigatório na criação de usuário.
     *
     * @return {@link AppException} com código {@code USER_CELULA_REQUIRED} (400).
     */
    public static AppException userCelulaRequired() {
        return new AppException(ErrorCode.USER_CELULA_REQUIRED);
    }
    ...
    public enum ErrorCode {
        ...
        USER_CELULA_REQUIRED(400, "Todo usuário deve pertencer a uma célula"),
